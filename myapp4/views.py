...
from myapp4.models import Client, Order, Product, OrderProducts
...
def index(request):
    """Главная страница."""
    return render(request, 'myapp4/base.html')
...
def clients_list(request):
    ...
    return render(request, 'myapp4/clients_list.html', context)
...
def client_orders(request, client_id):
    ...
    return render(request, 'myapp4/client_orders.html', context)
...
def client_prods(request, client_id, days_history):
    ...
    return render(request, 'myapp4/client_products.html', context)
