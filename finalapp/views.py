...
from finalapp.forms import ProductForm
from finalapp.models import Client, Order, Product, OrderProducts


def index(request):
    """Главная страница."""
    return render(request, 'finalapp/base.html')
...
def clients_list(request):
    ...
    return render(request, 'finalapp/clients_list.html', context=context)
...
def client_orders(request, client_id):
    ...
    return render(request, 'finalapp/client_orders.html', context)
...
def client_prods(request, client_id, days_history):
    ...
    return render(request, 'finalapp/client_products.html', context)
...
def products_list(request, show_no_del: str = 'no'):
    ...
    return render(request, "finalapp/products_list.html", context)
...
def product_create(request):
    ...
    return render(request, 'finalapp/product_create.html', {'title': 'Новый товар', 'form': form})
...
def product_edit(request, prod_id: int = None):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'finalapp/product_create.html', context)
    else:
...
def product_info(request, prod_id: int):
    ...
    return render(request, 'finalapp/product_info.html', {'prod': prod})